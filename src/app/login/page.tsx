                ...
                <form className="bg-white shadow-2xl rounded-lg px-10 pt-8 pb-10" onSubmit={handleSubmit}>
                    ...
                    >
                        <motion.button
                            ...
                            className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-3 px-6 rounded-lg focus:outline-none focus:shadow-outline transition-colors duration-200 ease-in-out flex items-center justify-center gap-2 min-w-[120px]"
                            type="submit"
                            disabled={loading}
                        >
                            {loading ? (
