        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            <input
              ...
              className="w-full p-2 border border-gray-300 rounded-md focus:ring-1 focus:ring-blue-500 focus:border-transparent transition-all duration-200 text-base"
              required
            />
          </motion.div>
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <input
                    ...
                    className="p-2 border border-gray-300 rounded-md focus:ring-1 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                    required
                  />
                  <select
                    value={field.type}
                    onChange={(e) => updateField(index, { type: e.target.value })}
                    className="p-2 border border-gray-300 rounded-md focus:ring-1 focus:ring-blue-500 focus:border-transparent transition-all duration-200 appearance-none bg-white"
                ...
                {field.type === 'select' && (
                  ...
                  >
                      ...
                      {field.options?.map((option, optionIndex) => (
                        ...
                        >
                          <input
                            ...
                            className="p-2 border border-gray-300 rounded-md focus:ring-1 focus:ring-blue-500 focus:border-transparent transition-all duration-200 flex-grow"
                    ...
                    <motion.button
                      ...
                      className="mt-2 bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 transition-colors duration-200 text-sm"
                    >
                      Добавить опцию
                    </motion.button>
                  </motion.div>
          ...
          >
            <motion.button
              ...
              type="button"
              onClick={addField}
              className="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 transition-colors duration-200 text-base font-semibold"
            >
              Добавить поле
            </motion.button>
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              type="submit"
              className="bg-green-500 text-white px-4 py-2 rounded-md hover:bg-green-600 transition-colors duration-200 text-base font-semibold"
            >
              Сохранить форму
            </motion.button>
          </motion.div>
